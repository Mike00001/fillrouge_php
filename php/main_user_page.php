						...
						<!-- Actions -->
							<section>
								<ul class="actions vertical">
                                    <li><a href="add_blog_post.php" class="button big fit">Add Post</a></li>
                                    <li><a href="show_post.php" class="button big fit">Edit Post</a></li>
                                    <?php
                                      $req=$con->query('SELECT id_user FROM user WHERE id_user=14');
                                   $user=$req->fetch();
              if ($_SESSION['id_user'] == $user['id_user'])
             {
                echo "<li><a href='add_categories.php' class='button big fit'>Modify categories</a></li>";
              }
               ?>
                                      
									<li><a href="log_out.php" class="button big fit">Log Out</a></li>
